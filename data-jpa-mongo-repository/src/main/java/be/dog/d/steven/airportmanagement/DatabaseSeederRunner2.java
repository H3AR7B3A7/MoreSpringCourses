...
@Component
@Order(3) // This overrides the previous DatabaseSeederRunner. Change order for MongoTemplate implementation.
@ConditionalOnProperty(
        prefix = "airport",
        value = "seeding.enabled",
        havingValue = "true",
        matchIfMissing = true)
public class DatabaseSeederRunner2 implements CommandLineRunner {
    private final FlightInformationRepository repository;

    public DatabaseSeederRunner2(FlightInformationRepository repository) {
    ...
    private void seed() {
        ...
        flightFour.setType(FlightType.National);
        ...
        flightFive.setType(FlightType.National);
